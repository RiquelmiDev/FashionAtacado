        ...
        <div class="container-fluid d-flex flex-column justify-content-center align-items-center"
            style="min-height: 100vh;">
                ...
                <div class="area p-4 mb-0">
                    <form action="sucessoApagarCarrossel.php" method="post">
                        
                   <h1>DADOS DELETADOS COM SUCESSO</h1>
                           
                        
                        <a class="botao container-fluid d-flex flex-column justify-content-center align-items-center" href="../carrinho.php">Voltar para tabela</a>
                    </form>
                </div>
        </div>    
    </main>
